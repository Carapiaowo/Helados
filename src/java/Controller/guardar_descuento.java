 ...
 * @author Danielao.0
 */
public class guardar_descuento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       Cdescuento pre = new Cdescuento();
       
       pre.setValor(valor);
       
       int estatus = CdescuentoCRUD.registrar_descuento(pre);
